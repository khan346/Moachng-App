...
import '../../now_screen/view/now_screen_2.dart';
import '../../training _result/training_result_screen.dart';
import '../../training_program/view/training_program_screen.dart';
import '../../utils/style.dart';
import 'flat_db_bench_press_2.dart';
class FlatDbBenchPress_4 extends StatelessWidget {
  const FlatDbBenchPress_4({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(child: Column(
        children: [
          ...
          customContainerList(
            ...
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>NowScreen_2()));
            },
            context: context,
          ),
  ...
  customContainerList({final title,final subtitle,
    final isComplete=false,
    final cross,final containerBackColor,final onTap,BuildContext? context}){
    return InkWell(
      onTap: onTap,
      child: Container(
        height: 50,
          ...
          children: [
           ...
           Container(
             ...
             alignment: Alignment.center,
              ...
              child: Icon(Icons.keyboard_arrow_down_sharp,color: AppColor.appBackGroundColor,),):SizedBox.shrink(),
          ],
        ),
      ),
    );
