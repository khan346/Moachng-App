...
import 'package:moaching_app/module_one/training%20_result/complete_training_screen.dart';
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>CompleteTrainingScreen()));
