            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text("Add To BreakFast",style: TextStyle( color: Color(0xff3A9090),
                  ...
                  children: [
                    Row(
                      children: [
                        CircleAvatar(
                          radius: 40.0,
                          backgroundImage: AssetImage("images/sandwhich_image.png"),
                        ...
                        Column(
                          ...
                          children: [
                            Text("WHole Green noodles Rema 100",style: TextStyle(
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  children: [
                                    Text("Kcaal",style: TextStyle(color: Colors.grey),),
                                    Text("0"),
                                  ],
                                ),
                                SizedBox(
                                ...
                                Column(
                                  children: [
                                    Text("Proteins",style: TextStyle(color: Colors.grey),),
                                    Text("0 g"),
                                  ],
                                ),
                                SizedBox(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>SearchForFood()));
                      },
                      child: Container(
                        ...
                        child: Center(child: Text("   Choose for 100g",
              ...
              Text("Pr. 100 g",style: TextStyle( color: Color(0xff3A9090),
                fontSize: 22,fontWeight: FontWeight.w600,
              )),
