          ...
          child: Column(
            children: [
              Padding(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("Your Macro Numbers",style: TextStyle( color: Color(0xff3A9090),
              ...
              CircularPercentIndicator(
                ...
                lineWidth: 13.0,
                percent: 1.0,
                center: new Text("Energy Percentage",
                textAlign: TextAlign.center,
                style: TextStyle(color: Color(0xff3A9090),fontSize: 22,
