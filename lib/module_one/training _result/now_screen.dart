...
import '../flat_db_bench_press/view/flat_db_bench_press_1.dart';
import 'diet_plane_screen_one.dart';
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.clear,
                      size: 20,),
                    Text("Now",style: TextStyle( color: Color(0xff3A9090),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text("3 mints",style: TextStyle(color: Colors.grey),)
                        ],
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      Text("Without Equipment",style: TextStyle(color: Colors.grey,
              ...
              InkWell(
                ...
                //  Navigator.push(context, MaterialPageRoute(builder: (context)=>DietPlanScreenone()));
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>FlatDbScreen()));
                },
                child: Container(
                  height: 40,
